...
public class CustomSkeletons extends CustomEnemy implements Listener {
    ...
    private static final Set<Biome> desertBiomes = Set.of(
            Biome.DESERT,
            Biome.BADLANDS,
    ...
    public void onSkeletonSpawn(CreatureSpawnEvent event) {
         ...
         *
         * 33.33% = lanjut menjadi custom Terraria
         * 66.67% = tetap Skeleton vanilla
         */
        ...
        // =====================================================
            ...
            switch (yLevel) {
                ...
                case 1 -> {
                    // Tidak ada custom skeleton di surface
                }
    ...
    public void spawnSkeletonArcher(Skeleton skeleton) {
        ...
        skeleton.setCustomName(
                lang.get("enemies", "skeleton_archer.name")
        );

        skeleton.setCustomNameVisible(false);

        skeleton.getAttribute(Attribute.MAX_HEALTH)
                .setBaseValue(40);
        ...
        equipment.setHelmet(
                SkeletonArcherHat.getItem(plugin)
        );
    ...
    public void spawnUndeadMiner(Skeleton skeleton) {
        ...
        skeleton.setCustomName(
                lang.get("enemies", "undead_miner.name")
        );
        ...
        equipment.setHelmet(
                UndeadMinerHat.getItem(plugin)
        );

        equipment.setChestplate(
                UndeadMinerChestplate.getItem(plugin)
        );
    ...
    public void spawnTim(Skeleton skeleton) {
        ...
        skeleton.getAttribute(Attribute.MOVEMENT_SPEED)
                .setBaseValue(0);
        ...
        equipment.setChestplate(
                TimChestplate.getItem(plugin)
        );

        equipment.setLeggings(
                TimLeggings.getItem(plugin)
        );
    ...
    public void spawnIceGolem(Skeleton skeleton) {
        ...
        skeleton.setCustomName(
                lang.get("enemies", "ice_golem.name")
        );
        ...
        skeleton.getAttribute(Attribute.KNOCKBACK_RESISTANCE)
                .setBaseValue(5);

        skeleton.getAttribute(Attribute.ATTACK_DAMAGE)
                .setBaseValue(25);

        skeleton.getAttribute(Attribute.SCALE)
                .setBaseValue(2.5);
        ...
        equipment.setHelmet(
                IceGolemHat.getItem(plugin)
        );

        equipment.setChestplate(
                IceGolemChestplate.getItem(plugin)
        );

        equipment.setLeggings(
                IceGolemLeggings.getItem(plugin)
        );

        equipment.setBoots(
                IceGolemBoots.getItem(plugin)
        );
    ...
    public void spawnRuneWizard(Skeleton skeleton) {
        ...
        skeleton.setCustomName(
                lang.get("enemies", "rune_wizard.name")
        );
        ...
        equipment.setHelmet(
                RuneWizardHat.getItem(plugin)
        );

        equipment.setChestplate(
                RuneWizardChestplate.getItem(plugin)
        );

        equipment.setLeggings(
                RuneWizardLeggings.getItem(plugin)
        );
    ...
    public void spawnSandElemental(Skeleton skeleton) {
        ...
        skeleton.setCustomName(
                lang.get("enemies", "sand_elemental.name")
        );
        ...
        equipment.setHelmet(
                SandElementalHat.getItem(plugin)
        );
